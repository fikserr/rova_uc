    ...
    return (
        <>
            ...
            <div className="min-h-screen flex">
                ...
                {/* Right Panel — Form */}
                <div className="w-full lg:w-1/2 flex items-center justify-center bg-[#f7f7fb] dark:bg-[#0d0d14] px-6 py-12">
                    <div className="w-full max-w-md">
                        ...
                        {/* Status */}
                        {status && (
                            <div className="mb-5 p-4 rounded-xl bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-200 dark:border-emerald-700">
                        ...
                        {/* Card */}
                        <div className="bg-white dark:bg-white/5 rounded-2xl shadow-xl shadow-black/5 dark:shadow-black/30 border border-gray-100 dark:border-white/10 p-8 space-y-5">
                            {/* Username */}
                            <div>
                                <label
                                    htmlFor="username"
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        className={`w-full pl-10 pr-4 py-2.5 text-sm bg-gray-50 dark:bg-white/5 border rounded-xl outline-none transition-all
                            ...
                            <div>
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        className={`w-full pl-10 pr-11 py-2.5 text-sm bg-gray-50 dark:bg-white/5 border rounded-xl outline-none transition-all
                                            placeholder:text-gray-400 dark:placeholder:text-gray-500
                                            text-gray-900 dark:text-white
                                            focus:ring-2 focus:ring-indigo-500/40 focus:border-indigo-500
                                            ${
                            ...
                            <div className="flex items-center">
                                <label className="flex items-center gap-2.5 cursor-pointer select-none group">
                                    <div className="relative">
                                        ...
                                        />
                                        <div className="w-4.5 h-4.5 rounded border-2 border-gray-300 dark:border-gray-600 peer-checked:bg-indigo-600 peer-checked:border-indigo-600 transition-all flex items-center justify-center">
                                            {data.remember && (
                                                <svg
                            ...
                            <button
                                ...
                                disabled={processing}
                                className="w-full relative overflow-hidden bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-400 dark:disabled:bg-indigo-800 text-white font-semibold text-sm py-2.5 px-4 rounded-xl transition-all duration-200 flex items-center justify-center gap-2 shadow-lg shadow-indigo-500/30 hover:shadow-indigo-500/50 active:scale-[0.98]"
                            >
                                {processing && (
