...
export default function UcOrders() {
    const { ucOrders: uc0 = [], serviceOrders: sv0 = [] } = usePage().props;
    const [data, setData]   = useState({ ucOrders: uc0, serviceOrders: sv0 });
    ...
    const counts = { uc: data.ucOrders.length, service: data.serviceOrders.length };
            ...
            <div className="flex items-start justify-between gap-3">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1 dark:text-white/60">
                        UC: {counts.uc} ta · Service: {counts.service} ta
                    </p>
                </div>
